                        ...
                        <!-- content starts here -->
                            ...
                            <form method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                                ...
                                <div class="form-group">
									...
									<div class="col-md-4">
                                        <select name="level" class="select2_single form-control" required="required" tabindex="-1" >
                                            ...
                                            <option value="CE">ARC</option>
                                            <option value="CE">BOM</option>
                                            <option value="CE">BSA</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" name="section" placeholder="Section Ex: CPE42" id="first-name2" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                        <!---        <div class="form-group">
