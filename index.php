...
<head>
    ...
    <title>De La Salle University - Dasmariñas</title>
...
<body style="background: linear-gradient(rgba(0,0,0,0.6),rgba(0, 0, 0, 0.6)),url('images/bg1.jpg');">
                ...
                <section class="login_content">
                    <form action="" method="post">
                        ...
                        <div class="separator">
                            ...
                            <br />
                            <div>
                                <h1><i class="fa fa-university" style="font-size: 26px;"></i> De La Salle University - Dasmariñas</h1>
